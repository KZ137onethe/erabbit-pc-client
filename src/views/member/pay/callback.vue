<template>
	<div class="pay-result container">
		...
		<a-result class="main" status="success" title="订单支付成功" sub-title="我们将尽快为您发货，收货期间请保持手机畅通">
			<template #extra>
				<p>支付方式：在线支付</p>
				<p>
					支付金额： <b>&yen;{{ order?.payMoney }}</b>
				</p>
				...
				<span style="display: block; font-size: 14px; padding-top: 15px; color: gray"
					>温馨提示：小兔仙儿不会以订单异常，系统升级为由要求您点击任何网址链接进行退款操作，保护资产，谨慎操作。</span
				>
			</template>
		</a-result>
	</div>

<template>
  <div class="sub-sort">
    <div class="sort-label">
      ...
      <a-checkable-tag :class="{...onlySelected('publishTime')}" @change="sortHandle('publishTime')">
        最新商品
      </a-checkable-tag>
      <a-checkable-tag :class="{...onlySelected('orderNum')}" @change="sortHandle('orderNum')">
        最高人气
      </a-checkable-tag>
      <a-checkable-tag :class="{...onlySelected('evaluateNum')}" @change="sortHandle('evaluateNum')">
        评论最多
      </a-checkable-tag>
      <div class="sort-price">
        <a-checkable-tag @change="sortHandle('price')">
          ...
          <div class="selectIcon">
            <CaretUpOutlined
              :class="{...onlySelected('price', sort = 'asc')}"
            />
            <CaretDownOutlined
              :class="{...onlySelected('price', sort ='desc')}"
            />
          </div>
        </a-checkable-tag>
      </div>
